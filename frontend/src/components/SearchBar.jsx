  ...
  return (
    <div className="flex flex-col md:flex-row gap-4 items-stretch md:items-center w-full">
      ...
      <div className="flex items-center gap-2 overflow-x-auto pb-1 md:pb-0 custom-scrollbar">
        <div className="flex items-center gap-1.5 p-1 bg-gray-50 dark:bg-white/[0.03] border border-gray-200 dark:border-white/5 rounded-xl">
          {filters.map((filter) => (
            <button
              key={filter}
              ...
              className={`px-4 py-2 text-[10px] font-bold rounded-lg transition-all uppercase tracking-widest whitespace-nowrap ${
                activeFilter === filter
                  ...
                  : "text-gray-400 dark:text-gray-500 hover:text-gray-900 dark:hover:text-gray-300 hover:bg-white/5"
              }`}
            >
              {filter}
            </button>
        ...
        <button className="p-3 bg-gray-50 dark:bg-white/[0.03] border border-gray-200 dark:border-white/5 rounded-xl text-gray-500 hover:text-gray-900 dark:hover:text-white hover:bg-white/5 transition hidden sm:flex">
